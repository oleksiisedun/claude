...
| [project-improver](skills/project-improver/SKILL.md) | Audits the whole current project against the global `CLAUDE.md` (read fresh at run time), reports findings by section, and applies only approved fixes |
