...
| `docs/` | Situational convention detail linked from `CLAUDE.md` and read on demand: `data-testid.md`, `playwright-tests.md`, `css-design-system.md`, `readme-mermaid.md`, `google-apps-script.md` |
